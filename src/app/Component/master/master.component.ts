...
export class MasterComponent {
  ...
  filterProducts(): void {
    ...
    this.httpclient
      .get<Iproduct[]>(
        `https://localhost:44380/api/Product/Num?catagorgsId=${this.filterObj.catagorgsId}&suppliersId=${this.filterObj.suppliersId}&pg=${this.filterObj.pg}&item=${this.filterObj.item}`
      )
      .subscribe({
        next: (res) => {
